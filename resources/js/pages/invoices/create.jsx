      ...
      <div className="max-w-6xl p-4 mx-auto">
        ...
        {previewData && (
          <div className="modal modal-open">
            <div className="w-full max-w-2xl modal-box sm:max-w-4xl">
              ...
              <div className="p-4 border rounded bg-base-200">
                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row">
                  <div>
                    ...
                    <p className="text-sm opacity-70">{company?.address}</p>
                    <p className="text-sm opacity-70">{company?.phone}</p>
                  </div>
                ...
                <div className="p-4 mt-4 space-y-1 text-right border rounded shadow bg-base-100">
                  ...
                  <div>Ongkir: {Number(data.shipping_cost).toLocaleString()}</div>
                  <div>Diskon Tambahan: {Number(data.extra_discount).toLocaleString()}</div>
                  <div className="text-lg font-bold">Grand Total: {grandTotal.toLocaleString()}</div>
                </div>
                ...
                {data.signature_path && (
                  <div className="mt-6">
                    ...
                    <img src={URL.createObjectURL(data.signature_path)} alt="Signature" className="h-16 mt-2" />
                  </div>
                )}
              </div>
